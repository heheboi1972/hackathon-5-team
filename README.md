...
AI로 계획하고 스캐폴딩한건데, 문제점이 너무 많은 것 같아요. 
의존성 그래프가 이상해보이길래 물어봤더니, 실제 문제가 있고 고칠 시간은 없어 냅뒀습니다. 
다른 부분에서도 이와 같은 문제가 있을 것 같아. 일단 개발 시작 전에 문제가 되는 파일이 있는지 다같이 뒤져봐야 할 것 같아요. 
